...
1. Download `genome-divergence.zip` and unpack it. This will create a directory named `genome-divergence` containing several files and two subdirectories: `./seqs` and `./histos`.
